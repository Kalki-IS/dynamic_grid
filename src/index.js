...
for (var i = 0; i < productList.length; i++) {
  if (productList[i].isAccessory === false) {
    ...
    modelimg.className = "modelimg";
    modelimg.src = productList[i].preview;
    imgdiv.appendChild(modelimg);
    ...
    prodname.innerHTML = productList[i].name;

    var brandname = document.createElement("h4");
    brandname.className = "brand-name";
    brandname.innerHTML = productList[i].brand;

    var priceis = document.createElement("h5");
    priceis.className = "price-is";
    priceis.innerHTML = "Rs " + productList[i].price;

    detailsdiv.appendChild(prodname);
    detailsdiv.appendChild(brandname);
    detailsdiv.appendChild(priceis);
    clothlink.appendChild(imgdiv);
    clothlink.appendChild(detailsdiv);
    clothsec.appendChild(clothcard);
  }
}

mainSection.appendChild(clothsec);

var headertag1 = document.createElement("h2");
headertag1.innerHTML = "Accessories for Men and Women";
headertag1.className = "header-tag";
...
for (var n = 0; n < productList.length; n++) {
  if (productList[n].isAccessory === true) {
    var accCard = document.createElement("div");
    accCard.className = "card";

    var accLink = document.createElement("a");
    accLink.href = "#";
    accLink.className = "link1";
    accCard.appendChild(accLink);

    var imgdiv1 = document.createElement("div");
    imgdiv1.className = "img-div";

    var modelimg1 = document.createElement("img");
    modelimg1.className = "modelimg";
    modelimg1.src = productList[n].preview;
    imgdiv1.appendChild(modelimg1);

    var detailsdiv1 = document.createElement("div");
    detailsdiv1.className = "details-div";

    var prodname1 = document.createElement("h3");
    prodname1.className = "prod-name";
    prodname1.innerHTML = productList[n].name;

    var brandname1 = document.createElement("h4");
    brandname1.className = "brand-name";
    brandname1.innerHTML = productList[n].brand;

    var priceis1 = document.createElement("h5");
    priceis1.className = "price-is";
    priceis1.innerHTML = "Rs " + productList[n].price;

    detailsdiv1.appendChild(prodname1);
    detailsdiv1.appendChild(brandname1);
    detailsdiv1.appendChild(priceis1);
    accLink.appendChild(imgdiv1);
    accLink.appendChild(detailsdiv1);
    accSec.appendChild(accCard);
  }
}

mainSection.appendChild(accSec);
